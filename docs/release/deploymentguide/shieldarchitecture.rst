...
Includes one machine running the **Shield-Management** & **Shield-Proxy** components on it. This machine should be 
placed in the Domain. A second machine, running the **Shield-Log**, **Farm Services** & **Browser Farm** components on it. This machine should 
be placed in the DMZ.
